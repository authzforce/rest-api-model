...
## Unreleased
### Added
- API allows the special keyword "latest" as version ID to get the latest version of a given policy (in addition to XACML version IDs like before), e.g. URL path .../policies/P1/latest represents the latest version of policy "P1"
